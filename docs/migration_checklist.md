...
This checklist is meant to keep the repository shippable while moving from in-memory seams to Firebase-backed implementations.
...
## Phase 3: Repository-by-Repository Migration
...
## Phase 5: Rule And Backend Validation
